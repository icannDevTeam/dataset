...
function isSameOriginRequest(req) {
  // Determine the origin we expect requests to use (scheme + host + port).
  // Vercel terminates TLS upstream, so honor X-Forwarded-Proto when present.
  ...
  // Prefer Origin (sent by every modern browser on cross-origin writes,
  // unspoofable from JS). Fall back to Referer for plain navigations.
