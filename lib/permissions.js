...
export const FEATURES = {
  ...
  pickup_admin:       { label: 'Pickup System Review',  icon: 'ph-hand-waving',        actions: [
                        ...
                        aliasPaths: ['/v2/chaperones', '/v2/officer-overrides', '/v2/security', '/v2/pickup-monitor', '/v2/pickup-ops', '/v2/system-interfaces', '/v2/chaperone/[id]', '/v2/terminals', '/v2/release-groups', '/v2/pickup-enroll'],
