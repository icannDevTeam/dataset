...
export const FEATURES = {
  ...
  analytics:          { label: 'Analytics',           icon: 'ph-chart-line-up',      actions: ['view', 'export', 'view_pii'],         path: '/v2/analytics' },
  ...
  pickup_admin:       { label: 'Pickup System Review',  icon: 'ph-hand-waving',        actions: [
                        ...
                        aliasPaths: ['/v2/chaperones', '/v2/officer-overrides', '/v2/security', '/v2/chaperone/[id]', '/v2/terminals', '/v2/release-groups', '/v2/pickup-kiosks', '/v2/pickup-enroll'],
                        ...
                        subModules: [
                          { key: 'review',      label: 'Review Queue',           icon: 'ph-clipboard-text',  actions: ['view', 'approve', 'reject', 'bulk_approve', 'bulk_reject'] },
  ...
  downloads:          { label: 'Downloads Hub',       icon: 'ph-download-simple',    actions: [
                          'view',
                          // Operational exports — attendance, chaperone roster, etc.
                          'download_operational',
                          // Security exports — security incidents, access logs
                          'download_security',
                          // Audit / compliance exports — full audit log
                          'download_audit',
                        ...
                        subModules: [
                          ...
                          { key: 'audit',       label: 'Audit & Compliance',  icon: 'ph-scales',        actions: ['download_audit'] },
                        ] },
};
...
export const FEATURE_GROUPS = [
  ...
  { label: 'Pickup System', features: ['pickup_admin'] },
  { label: 'Administration', features: ['settings', 'user_management', 'security_audit', 'downloads', 'ai_parameters', 'notifications', 'integrations'] },
];
