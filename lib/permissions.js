...
export const FEATURES = {
  ...
  pickup_admin:       { label: 'PickupGuard Review',  icon: 'ph-hand-waving',        actions: ['view', 'edit'],           path: '/v2/pickup-admin',
                        aliasPaths: ['/v2/chaperones', '/v2/officer-overrides', '/v2/security', '/v2/chaperone/[id]', '/pickup/teacher', '/v2/terminals', '/v2/release-groups', '/v2/pickup-kiosks'] },
  ...
  teacher_management: { label: 'Teacher Management',  icon: 'ph-chalkboard-teacher', actions: ['view', 'edit', 'delete'], settingsTab: 'teacher-management' },
...
export const FEATURE_GROUPS = [
  ...
  { label: 'Administration', features: ['settings', 'user_management', 'teacher_management', 'security_audit', 'ai_parameters', 'notifications', 'integrations'] },
];
...
const ROLE_DEFAULTS = {
  ...
  teacher: {
    ...
    analytics: false,
    reports: false,
    attendance_monitor: false,
    enrollment: false,
    mobile_enrollment: false,
    device_manager: false,
    hikvision: false,
    device_sync: false,
    pickup_admin: ['view', 'edit'],
    settings: false,
    user_management: false,
  ...
  // Security guard at the gate: can view TV feed and submit officer overrides
  guard: {
    dashboard: ['view'],
    analytics: false,
    reports: false,
