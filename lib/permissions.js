...
export const FEATURES = {
  ...
  pickup_admin:       { label: 'Pickup System Review',  icon: 'ph-hand-waving',        actions: [
                        ...
                        aliasPaths: ['/v2/chaperones', '/v2/officer-overrides', '/v2/security', '/v2/chaperone/[id]', '/v2/terminals', '/v2/release-groups', '/v2/pickup-enroll', '/v2/pickup-map', '/v2/terminal-assignments'],
  ...
  // These pages expose raw infrastructure telemetry, live operational
  ...
  // Cost Monitor is ultra-private — visible ONLY to icanntechindo@gmail.com.
  // The page enforces an additional email check beyond the owner permission gate.
  cost_monitor:        { label: 'Cost Monitor',         icon: 'ph-currency-dollar',    actions: ['view'], path: '/v2/cost-monitor' },
...
export const FEATURE_GROUPS = [
  ...
  { label: 'Owner-Only Modules', features: ['system_monitor', 'operation_interface', 'system_interface', 'cost_monitor'] },
