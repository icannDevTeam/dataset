...
const reportRunsPath = (t) => `${tenantDoc(t)}/reportRuns`;
const reportRunDoc   = (id, t) => `${reportRunsPath(t)}/${id}`;
const reportPresetsPath = (t) => `${tenantDoc(t)}/reportPresets`;
const reportPresetDoc   = (id, t) => `${reportPresetsPath(t)}/${id}`;

// ─── Pickup System (chaperone pick-up) ────────────────────────────────
...
const pickupIntegrationsDoc = (t) => `${tenantDoc(t)}/settings/pickup_integrations`;
const pickupContactsPath = (t) => `${tenantDoc(t)}/pickup_contacts`;
const pickupEmailTemplatesPath = (t) => `${tenantDoc(t)}/pickup_email_templates`;
const pickupOnboardingPath = (t) => `${tenantDoc(t)}/pickup_onboarding`;
const pickupStudentLocksPath = (t) => `${tenantDoc(t)}/pickup_student_locks`;
const pickupClassesPath = (t) => `${tenantDoc(t)}/pickup_classes`;
...
// Phase 2: terminals (Hikvision face terminals registry), release_groups
// (binds N terminals + 1 tablet for a grade), tablet_devices (paired iPads).
const terminalsPath       = (t) => `${tenantDoc(t)}/terminals`;
const terminalDoc         = (id, t) => `${terminalsPath(t)}/${id}`;
const releaseGroupsPath   = (t) => `${tenantDoc(t)}/release_groups`;
const releaseGroupDoc     = (id, t) => `${releaseGroupsPath(t)}/${id}`;
const tabletDevicesPath   = (t) => `${tenantDoc(t)}/tablet_devices`;
const tabletDeviceDoc     = (id, t) => `${tabletDevicesPath(t)}/${id}`;
...
module.exports = {
  ...
  pickupOverridesPath,
  pickupSettingsDoc,
  pickupIntegrationsDoc,
  pickupContactsPath,
  pickupEmailTemplatesPath,
  pickupOnboardingPath,
  pickupStudentLocksPath,
  pickupClassesPath,
  idAllocationsDoc,
