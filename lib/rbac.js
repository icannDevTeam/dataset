...
const ACTIONS = Object.freeze({
  ...
  'downloads.download_operational':    { label: 'Export operational data (attendance, chaperones)', risk: 'write' },
  'downloads.download_security':       { label: 'Export security data (incidents, access logs)',    risk: 'admin' },
  'downloads.download_audit':          { label: 'Export full audit log',           risk: 'admin' },
});
