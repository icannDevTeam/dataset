 ...
 *
 * Two shells coexist on purpose:
 *  - Classic navy/gold card (no images) — invite + form-submission emails,
 *    with a text-only BINUS SPIRIT footer.
 *  - "Spry" shell (lavender hero, logo, purple CTA) — password reset flow ONLY.
 *
...
// Spry shell palette (password reset flow only)
...
// Text-only BINUS SPIRIT footer for the classic shell — no images/logo by design.
// Keep in sync with firebase-functions/index.js (SPIRIT_FOOTER_HTML).
const SPIRIT_FOOTER_HTML = `
        <tr><td style="background:${SURFACE};border-top:1px solid ${BORDER};padding:20px 28px;text-align:center;">
          <div style="font-size:11px;letter-spacing:4px;text-transform:uppercase;color:${BRAND_NAVY};font-weight:700;">Binus Spirit</div>
          <div style="margin-top:8px;font-size:12px;color:${TEXT_MUTED};line-height:1.9;">
            <strong style="color:${BRAND_NAVY};">S</strong>triving for Excellence&nbsp;&nbsp;&middot;&nbsp;&nbsp;<strong style="color:${BRAND_NAVY};">P</strong>erseverance&nbsp;&nbsp;&middot;&nbsp;&nbsp;<strong style="color:${BRAND_NAVY};">I</strong>ntegrity<br>
            <strong style="color:${BRAND_NAVY};">R</strong>espect&nbsp;&nbsp;&middot;&nbsp;&nbsp;<strong style="color:${BRAND_NAVY};">I</strong>nnovation&nbsp;&nbsp;&middot;&nbsp;&nbsp;<strong style="color:${BRAND_NAVY};">T</strong>eamwork
          </div>
...
/**
 * Spry-style shell — used by the password reset flow only.
 *
 * @param {object} opts
 * @param {string} opts.title        — <title> / preheader
 * @param {string} opts.heading      — bold card heading ("Hi, Jane!")
 ...
 * successful pickup form submission. Classic navy shell, no images.
 *
 * @param {object} opts
 ...
 * Spry shell (the only flow that uses it).
 *
 * @param {object} opts
 * @param {string} opts.name        — user display name
 * @param {string} opts.email       — login email (also recipient)
 ...
 * Spry shell (part of the password reset flow).
 *
 * @param {object} opts
